...
- **More consumers of the same coords**: cell / structure segmentation (``--task patch_seg``;
  HistoPlus, CellViT++, and the promptable weave/SAM3) and VLM question answering over ROIs
  (``--task vlm``; Patho-R1).
